...
**Contents**
  ...
  - [Exercise 1: Getting Started](./Exercise-1-Getting-Started-readme.md)
    - [Task 1: Review Azure SQL Database](./Exercise-1-Getting-Started-readme.md#task-1-review-azure-sql-database)
  - [Exercise 2: Control Access](./Exercise-2-Control-Access-readme.md)
    - [Task 1:Configure Azure AD Login for your Azure SQL DB](./Exercise-2-Control-Access-readme.md#task-1-configure-azure-ad-login-for-your-azure-sql-db)
    - [Task 2: Access the Database using SQL Server Management Studio](./Exercise-2-Control-Access-readme.md#task-2-access-the-database-using-sql-server-management-studio)
  - [Exercise 3: Protect Data](./Exercise-3-Protect%20Data-readme.md)
    - [Task 1: Transparent Data Encryption](./Exercise-3-Protect%20Data-readme.md#task-1-transparent-data-encryption)
    - [Task 2: Auditing](./Exercise-3-Protect%20Data-readme.md#task-2-auditing)
    - [Task 3: Threat Protection](./Exercise-3-Protect%20Data-readme.md#task-3-threat-protection)
